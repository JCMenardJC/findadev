...
export class CompetencesService {
    ...
    async update(id: number, updateCompetenceDto: UpdateCompetenceDto) {
        ...
        if (
            updateCompetenceDto.competence1 ==
                competenceChanged[0].competence1 ||
            updateCompetenceDto.competence2 ==
                competenceChanged[0].competence2 ||
            updateCompetenceDto.competence3 ==
                competenceChanged[0].competence3 ||
            updateCompetenceDto.competence4 ==
                competenceChanged[0].competence4 ||
            updateCompetenceDto.competence5 ==
                competenceChanged[0].competence5 ||
